...
export default function NoteModal({ isOpen, handleClose, handleSubmit, selectedBooking, isList, children, ...props }) {
  ...
  useEffect(() => {
    if (isList) getNotes(selectedBooking.id);
  }, []);
        ...
        <Box style={style.box}>
          ...
          <div id="modal-modal-description" style={style.body}>
            <FormControl style={style.form}>
              ...
              <Grid container>
                ...
                <Grid item xs={6} style={style.flexEnd}>
                  <FormControlLabel
                    label="Thông báo cho quản lý"
                    labelPlacement="start"
                    control={<Checkbox checked={isSend} onChange={(e) => setIsSend(e.target.checked)} />}
                  />
                </Grid>
              </Grid>
              <TextField
            ...
            <div style={style.buttonWrap}>
              ...
              <Button type="submit" variant="contained" style={style.submitButton} onClick={handleSubmitForm}>
                Lưu
              </Button>
            </div>
          </div>
