...
import { bannerImage, initCounsellingPrice } from '../../../../store/constants/initial';
import {
    QueueMusic,
    History,
...
const BannerModal = () => {
    ...
    const setURL = (image) => {
        // banner.is_video ? seturl('https://firebasestorage.googleapis.com/v0/b/huongnghiepnhanh.appspot.com/o/Banner%2Fpng-transparent-computer-icons-video-player-scalable-graphics-youtube-video-player-icon-angle-rectangle-triangle-thumbnail.png?alt=media&token=143b3b76-4202-4f49-92a3-32218a6b465d') : seturl(image)
    ...
    const handleSubmitForm = async () => {
        try {
            // banner.is_video ? setbanner({ ...banner, video_url: url }) : setbanner({ ...banner, banner_url: url })
    ...
    useEffect(() => {
        ...
        setbanner({
            ...banner,
            ...selectedDocument,
            // image_url: selectedDocument.image_url || bannerImage,
        });
        // selectedDocument.is_video ? seturl('https://firebasestorage.googleapis.com/v0/b/huongnghiepnhanh.appspot.com/o/Banner%2Fpng-transparent-computer-icons-video-player-scalable-graphics-youtube-video-player-icon-angle-rectangle-triangle-thumbnail.png?alt=media&token=143b3b76-4202-4f49-92a3-32218a6b465d') : seturl(selectedDocument.banner_url)
    }, [selectedDocument]);
                                        ...
                                        <Grid item lg={12} md={12} xs={12}>
                                            <div className={classes.tabItem}>
                                                ...
                                                <div className={`${classes.tabItemBody} ${classes.tabItemMentorAvatarBody}`}>
                                                    <img src={banner.is_video ? banner.video_url ? 'https://firebasestorage.googleapis.com/v0/b/huongnghiepnhanh.appspot.com/o/Banner%2Fpng-transparent-computer-icons-video-player-scalable-graphics-youtube-video-player-icon-angle-rectangle-triangle-thumbnail.png?alt=media&token=143b3b76-4202-4f49-92a3-32218a6b465d' : undefined : banner.banner_url} alt="" />
                                                    <div>
