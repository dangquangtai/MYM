...
const Chat = () => {
  ...
  const { getChatBoxList, getChatMessage, postChatMessage, fetchChatBox } = useShare();
  ...
  const fetchChatBoxList = async () => {
    const data = await getChatBoxList();
    setChatboxs(data);
    handleChatBoxClick(data[0]);
  };
  ...
  const handleChatBoxClick = (chatbox) => {
    ...
    <div className={classes.mailroot}>
      <div className={classes.mailwrapper}>
            ...
            <List component="div" className={classes.mailinboxelist}>
              {chatboxs.map((chatbox, index) => (
                <React.Fragment key={index}>
                  <ListItem
                    button
                    onClick={() => handleChatBoxClick(chatbox)}
                    selected={chatbox.id === selectedChatbox?.id}
                  >
                    <ListItemAvatar>
                      <React.Fragment>
                    ...
                    <ListItemText
                      ...
                      secondary={
                        <Typography component="div" variant="body1" className={classes.listitemchip}>
                          {moment(chatbox.updated_date).fromNow()}
                        </Typography>
                      }
                    />
                  </ListItem>
        ...
        <div className={classes.mailcontent}>
          ...
          <PerfectScrollbar className={classes.ScrollHeightinbox} containerRef={setScrollEl}>
